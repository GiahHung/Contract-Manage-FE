    ...
    <div class="w-dvw h-dvh bg-gray-200 grid grid-cols-7">
      <div class="col-span-1 bg-white">
        <div class="p-2 h-full w-full flex flex-col bg-white dark:bg-gray-900 border-r border-r-gray-200">
            ...
            <div class="flex flex-col  space-y-1 mx-1 lg:mt-1 ">
              <div class="px-5 pt-4 hidden lg:block">
                <div class="flex flex-row items-center">
                  <div class="text-xs font-bold tracking-wide text-gray-600">
                    Menu
                  </div>
                </div>
              </div>
              <Link class="flex flex-row items-center  justify-center lg:justify-start rounded-md h-12 focus:outline-none pr-3.5  lg:pr-6 font-semibold text-gray-500 hover:text-primary-400 hover:bg-yellow-400 cursor-pointer ">
                ...
                <span class="ml-0 lg:ml-2 text-sm tracking-wide truncate capitalize hidden lg:block">
                  DashBoard
                </span>
              </Link>
              <Link class="flex flex-row items-center  justify-center lg:justify-start rounded-md h-12 focus:outline-none pr-3.5  lg:pr-6 font-semibold text-gray-500 hover:text-primary-400 hover:bg-yellow-400 cursor-pointer ">
              ...
              <Link class="flex flex-row items-center  justify-center lg:justify-start rounded-md h-12 focus:outline-none pr-3.5  lg:pr-6 font-semibold shadow-sm text-gray-500 hover:text-primary-400 hover:bg-yellow-400 font-bold ">
                <span class="inline-flex justify-center items-center ml-3.5">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1.25rem"
          ...
          <div class="px-1">
            <div class="flex flex-row items-center  justify-center lg:justify-start rounded-md h-12 focus:outline-none pr-3.5  lg:pr-6 font-semibold text-gray-500 hover:text-primary-400 cursor-pointer text-red-400 hover:text-red-600">
              <span class="inline-flex justify-center items-center ml-3.5">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1.25rem"
